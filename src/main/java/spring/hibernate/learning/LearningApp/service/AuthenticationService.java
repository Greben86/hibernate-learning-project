...
import spring.hibernate.learning.LearningApp.dto.ChangePasswordRequest;
import spring.hibernate.learning.LearningApp.dto.JwtAuthenticationResponse;
import spring.hibernate.learning.LearningApp.dto.SignInRequest;
...
public class AuthenticationService {
     ...
     * @return токен
     */
    public JwtAuthenticationResponse passwordChange(final ChangePasswordRequest request) {
